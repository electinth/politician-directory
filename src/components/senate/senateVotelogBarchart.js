              ...
              >
                {((senatorTypeId === 3 && props.width < 768) ||
                  ...
                  <BarChart
                    ...
                    types={types}
                    width_of_barChart={
                      is_mobile ? props.groupWidth[2] : props.groupWidth[2] - 90
                    }
                    color_bars={props.colors}
                    height_svg={height_svg}
                    is_On={props.is_On}
...
export default ({
  ...
  const marginAxis = width < 768 ? 0 : 80
